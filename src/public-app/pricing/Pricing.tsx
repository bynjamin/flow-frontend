                ...
                <Card className="relative">
                  ...
                  <CardContent className="text-center p-0">
                    <div
                      className={clsx(
                        classes.price,
                        'flex items-end justify-center py-16 px-32',
                      )}
                    >
            ...
            <div className="flex flex-col items-center py-96 text-center sm:text-left max-w-xl mx-auto">
              ...
              <div className="flex flex-wrap w-full">
                ...
                <div className="w-full sm:w-1/2 p-24">
                  ...
                  <Typography className="text-16" color="textSecondary">
                    Aliquam erat volutpat. Etiam luctus massa ex, at tempus
                    tellus blandit quis. Sed quis neque tellus. Donec maximus
                    ipsum in malesuada hendrerit.
                  </Typography>
                </div>
