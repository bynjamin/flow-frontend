...
import {
  InviteUserDialogRolesQuery as DataType,
  InviteUserDialogRolesQuery_userRoles as RoleType,
} from './__generated__/InviteUserDialogRolesQuery';
import {
  // eslint-disable-next-line no-unused-vars
...
const InviteUserDialog: React.FC<Props> = ({ open, onClose }) => {
  ...
  const { data } = useQuery<DataType>(ROLES_QUERY); // todo: error handling
