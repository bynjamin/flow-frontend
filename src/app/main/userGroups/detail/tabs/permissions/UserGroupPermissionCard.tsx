...
import { UPDATE_USER_GROUP_PERMISSIONS } from './mutations/updateUserGroupPermissionMutation';
import {
  // eslint-disable-next-line no-unused-vars
  UserGroupPermissionCardFragment__data as DataType,
} from './__generated__/UserGroupPermissionCardFragment__data';
import {
  // eslint-disable-next-line no-unused-vars
  UpdateUserGroupPermissions as ResponseType,
  // eslint-disable-next-line no-unused-vars
  UpdateUserGroupPermissionsVariables as InputType,
} from './mutations/__generated__/UpdateUserGroupPermissions';
// eslint-disable-next-line no-unused-vars
...
const UserGroupPermissionCard: React.FC<Props> = ({ data, groupId }) => {
  ...
  const [updateUserGroupPermissions] = useMutation<ResponseType, InputType>(
    UPDATE_USER_GROUP_PERMISSIONS,
  );
  ...
  const handleSave = async () => {
    ...
    const { data: response, errors } = await updateUserGroupPermissions({
      variables,
    });

    if (response) {
      if (response.updateUserGroupPermissions) {
...
export default UserGroupPermissionCard;
