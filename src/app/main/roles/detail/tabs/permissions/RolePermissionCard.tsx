...
import { UPDATE_ROLE_PERMISSIONS } from './mutations/updateRolePermissionMutation';
import {
  // eslint-disable-next-line no-unused-vars
  RolePermissionCardFragment__data as DataType,
} from './__generated__/RolePermissionCardFragment__data';
import {
  // eslint-disable-next-line no-unused-vars
  UpdateRolePermissions as ResponseType,
  // eslint-disable-next-line no-unused-vars
  UpdateRolePermissionsVariables as InputType,
} from './mutations/__generated__/UpdateRolePermissions';
// eslint-disable-next-line no-unused-vars
...
const RolePermissionCard: React.FC<Props> = ({ data, roleId }) => {
  ...
  const [updateRolePermissions] = useMutation<ResponseType, InputType>(
  ...
  const handleSave = async () => {
    ...
    const { data: response, errors } = await updateRolePermissions({
      variables,
    });

    if (response) {
      if (response.updateUserRolePermissions) {
